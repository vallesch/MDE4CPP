...
{
	class InternalTransitionActivationImpl :virtual public TransitionActivationImpl, virtual public InternalTransitionActivation 
	{
		public: 
		...
		private:    
			InternalTransitionActivationImpl& operator=(InternalTransitionActivationImpl const&) = delete;

		protected:
			friend class PSSM::PSSMFactoryImpl;
			InternalTransitionActivationImpl();
			virtual std::shared_ptr<InternalTransitionActivation> getThisInternalTransitionActivationPtr() const;
			virtual void setThisInternalTransitionActivationPtr(std::weak_ptr<InternalTransitionActivation> thisInternalTransitionActivationPtr);
		...
		private:
			std::weak_ptr<InternalTransitionActivation> m_thisInternalTransitionActivationPtr;
	};
}
