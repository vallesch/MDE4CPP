...
{
	class ShallowHistoryPseudostateActivationImpl :virtual public HistoryPseudostateActivationImpl, virtual public ShallowHistoryPseudostateActivation 
	{
		public: 
		...
		private:    
			ShallowHistoryPseudostateActivationImpl& operator=(ShallowHistoryPseudostateActivationImpl const&) = delete;

		protected:
			friend class PSSM::PSSMFactoryImpl;
			ShallowHistoryPseudostateActivationImpl();
			virtual std::shared_ptr<ShallowHistoryPseudostateActivation> getThisShallowHistoryPseudostateActivationPtr() const;
			virtual void setThisShallowHistoryPseudostateActivationPtr(std::weak_ptr<ShallowHistoryPseudostateActivation> thisShallowHistoryPseudostateActivationPtr);
		...
		private:
			std::weak_ptr<ShallowHistoryPseudostateActivation> m_thisShallowHistoryPseudostateActivationPtr;
	};
}
